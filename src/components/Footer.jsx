    ...
    <footer className="border-t text-white py-8 px-4 mt-28 mb-32 lg:mb-2">
      <div className="container mx-auto text-center">
        ...
        <div className="mb-6">
          ...
          <p className="text-gray-400">simplify your dev journey</p>
        </div>
        ...
        <div className="flex flex-col sm:flex-row  justify-center space-x-0 sm:space-x-6 mb-6">
          ...
          <a href="#services" className="text-gray-400  transition hover:text-blue-300 duration-300 ease-in-out mb-2 sm:mb-0">Services</a>
